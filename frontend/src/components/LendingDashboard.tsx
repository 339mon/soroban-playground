    ...
    <div className="p-6 bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className={`flex flex-col items-end`}>
          ...
          <span className={`text-2xl font-mono font-bold ${healthColor}`}>
            {healthFactor}
          </span>
        </div>
      </div>

      <div className="mb-6 p-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg text-white shadow-md">
        {" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-100 dark:border-slate-700">
          ...
          <div className="mt-4 flex gap-2">
            <button
              onClick={() => setBorrowed((b) => b + 50)}
              className="flex-1 flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white px-3 py-2 rounded-lg transition-colors"
            >
