    ...
    <div className="p-6 bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800">
        ...
        <div className="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-800">
          ...
          <div className="divide-y divide-slate-100 dark:divide-slate-800">
            {songs.map((song) => (
              <div
                key={song.id}
                className="p-4 grid grid-cols-4 items-center bg-white dark:bg-slate-900"
              >
      ...
      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800/50">
        ...
        <div className="text-xs text-blue-600 dark:text-blue-400">
          This contract automatically distributes incoming streaming revenue to
          all rights holders based on their defined percentage share.
        </div>
      </div>
    </div>
  );
