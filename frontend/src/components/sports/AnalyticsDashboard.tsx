...
export default function AnalyticsDashboard({
  ...
  analytics: Analytics | undefined | null;
}) {
    ...
    <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 shadow-xl space-y-8">
      <div className="space-y-4">
        ...
        <div className="h-4 bg-slate-900 rounded-full overflow-hidden flex">
          <div
            className="h-full bg-blue-500 w-[60%]"
            title="Lakers vs Warriors"
          ></div>
          <div
            className="h-full bg-purple-500 w-[30%]"
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {analytics.recent_activity.map((activity, i) => (
            <div
              key={i}
              className="flex justify-between items-center p-3 bg-slate-900/50 rounded-lg border border-slate-700/50"
            >
              <div>
