      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <header className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 gap-6">
          <div>
            <h1 className="font-space-grotesk text-4xl md:text-5xl font-bold tracking-tight mb-2 flex items-center gap-4">
              ...
              <span className="text-[#c2c6d8] text-2xl font-normal">
                // BOUNTY_HUB
              </span>
            </h1>
            <p className="text-[#c2c6d8] text-sm tracking-widest uppercase">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-[#1c1b1c]/80 backdrop-blur-xl border border-white/5 rounded-xl p-6 relative overflow-hidden group">
            ...
            <h3 className="text-[#c2c6d8] text-xs font-semibold tracking-widest uppercase mb-4">
              Total Bounties Paid
            </h3>
            <p className="font-space-grotesk text-4xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">
              $2.4M <span className="text-xl text-[#0070FF]">USDC</span>
            </p>
          </div>
          ...
          <div className="bg-[#1c1b1c]/80 backdrop-blur-xl border border-white/5 rounded-xl p-6 relative overflow-hidden group">
            ...
            <p className="font-space-grotesk text-4xl font-bold text-[#00FFFF] drop-shadow-[0_0_15px_rgba(0,255,255,0.3)]">
              156
            </p>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-6 border-b border-white/10 pb-4">
            <h2 className="font-space-grotesk text-2xl font-semibold tracking-tight">
              ACTIVE_BUG_BOUNTIES
            </h2>
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#00FFFF] animate-pulse"></span>
              <span className="text-[#00FFFF] text-xs tracking-widest uppercase font-semibold">
                Live Updates
              </span>
            </div>
          </div>
