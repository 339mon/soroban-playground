  ...
  return (
    <div className="min-h-screen bg-[#131314] text-[#e5e2e3] font-inter p-6 md:p-12 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <Link
          href="/bug-bounty"
          className="text-[#c2c6d8] hover:text-[#00FFFF] text-sm tracking-widest uppercase mb-8 inline-block transition-colors"
        >
          ← Back to Dashboard
        </Link>
        ...
        <header className="mb-10 border-b border-white/10 pb-6">
          <h1 className="font-space-grotesk text-3xl md:text-4xl font-bold tracking-tight mb-2">
            SUBMIT_REPORT{" "}
            <span className="text-[#00FFFF] font-normal">
              // NEW_VULNERABILITY
            </span>
          </h1>
          <p className="text-[#c2c6d8] text-sm">
            Provide detailed information about the vulnerability. All
            submissions are encrypted and verified on-chain.
          </p>
        </header>

        <form
          onSubmit={handleSubmit}
          className="bg-[#1c1b1c]/80 backdrop-blur-xl border border-white/10 rounded-xl p-8 shadow-2xl"
        >
          <div className="mb-6">
            <label className="block text-xs font-bold tracking-widest uppercase text-[#c2c6d8] mb-2">
              Bug Title
            </label>
            <input
              type="text"
          ...
          <div className="mb-8">
            <div className="flex justify-between items-end mb-2">
              <label className="block text-xs font-bold tracking-widest uppercase text-[#c2c6d8]">
                Description & Proof of Concept
              </label>
              <span className="text-xs text-[#00FFFF] bg-[#00FFFF]/10 px-2 py-1 rounded">
                Markdown Supported
              </span>
            </div>
            <textarea
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-white/10">
            <button
              type="button"
              className="w-full md:w-auto px-6 py-3 rounded-md bg-transparent text-[#c2c6d8] border border-white/20 hover:border-[#00FFFF] hover:text-[#00FFFF] transition-all flex items-center justify-center gap-2 text-sm font-semibold tracking-wider uppercase"
            >
              <svg
                width="16"
                height="16"
            ...
            <button
              type="submit"
              className="w-full md:w-auto px-8 py-3 rounded-md bg-[#0070FF] text-white font-bold tracking-widest uppercase text-sm border border-[#568dff] shadow-[0_0_20px_rgba(0,112,255,0.4)] hover:shadow-[0_0_30px_rgba(0,112,255,0.6)] hover:-translate-y-0.5 transition-all"
            >
              Submit Bug Report
            </button>
          </div>
