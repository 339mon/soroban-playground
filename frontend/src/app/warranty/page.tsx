      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <header>
          ...
          <p className="text-sm text-gray-400 mt-1">
            Decentralized product warranties with automated claims on Stellar
            Soroban.
          </p>
        </header>
        ...
        >
          ...
          <button
            onClick={applyConfig}
            className="w-full py-2 bg-orange-600 hover:bg-orange-500 text-white text-sm font-medium rounded transition-colors"
          >
            Connect
          </button>
        </section>
