      ...
      <div className="max-w-7xl mx-auto relative z-10 pb-32">
        ...
        <header className="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
          <div className="flex items-center gap-4">
            <h1 className="font-epilogue text-4xl font-extrabold tracking-tighter">
              SOUND_CHAIN
            </h1>
            <span className="bg-[#06B6D4]/10 text-[#06B6D4] text-xs font-bold px-2 py-1 rounded tracking-widest uppercase">
              Beta
            </span>
          </div>
        ...
        <div className="flex items-center gap-8 mb-12 border-b border-white/10 pb-6">
          <div>
            <p className="text-xs font-bold tracking-widest uppercase text-[#d6c0d3] mb-1">
              Total Volume
            </p>
            <p className="font-epilogue text-2xl font-bold text-[#06B6D4]">
              1.2M USDC
            </p>
          </div>
          <div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#12121A]/70 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex flex-col group hover:bg-[#12121A] transition-all">
              ...
              <h3 className="font-epilogue text-xl font-bold text-white mb-1">
                Neon Genesis
              </h3>
              <p className="text-[#d6c0d3] text-sm mb-4">Cyber_Punk_99</p>
              <div className="mt-auto flex items-center justify-between">
                <span className="bg-[#D946EF]/20 text-[#D946EF] text-xs font-bold px-2 py-1 rounded">
                  Exclusive
                </span>
            ...
            <div className="bg-[#12121A]/70 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex flex-col group hover:bg-[#12121A] transition-all">
              ...
              <p className="text-[#d6c0d3] text-sm mb-4">
                Synth_Wave_Collective
              </p>
              <div className="mt-auto flex items-center justify-between">
                <span className="bg-[#06B6D4]/20 text-[#06B6D4] text-xs font-bold px-2 py-1 rounded">
                  Non-Exclusive
                </span>
                <button className="px-4 py-2 rounded-md bg-[#D946EF] text-white text-sm font-bold shadow-[0_0_15px_rgba(217,70,239,0.4)] hover:shadow-[0_0_25px_rgba(217,70,239,0.6)] transition-shadow">
                  50 USDC
        ...
        {/* Recent Drops List */}
        <section>
          <h2 className="font-epilogue text-2xl font-bold mb-6">
            Recent Drops
          </h2>
            ...
            <div className="flex items-center justify-between bg-[#12121A]/50 backdrop-blur-md border border-white/5 rounded-xl p-4 hover:bg-[#12121A] transition-colors group">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#d6c0d3]">
                    Cyber_Punk_99 • 128 BPM • Techno
                  </p>
                </div>
              </div>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-[#1a101a]/90 backdrop-blur-xl border-t border-white/10 p-4 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-6">
          ...
          <div className="flex-1 flex flex-col items-center gap-2">
            <div className="flex items-center gap-4">
              <button className="text-[#d6c0d3] hover:text-white">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
            ...
            <div className="w-full flex items-center gap-3 max-w-md">
              ...
              <div className="flex-1 h-1 bg-white/10 rounded-full relative">
                <div
                  className="absolute top-0 left-0 h-full bg-gradient-to-r from-[#D946EF] to-[#06B6D4] rounded-full"
                  style={{ width: "45%" }}
                ></div>
              </div>
