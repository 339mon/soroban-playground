    ...
    <div className="min-h-screen bg-[#0A0A10] text-[#efddeb] font-inter p-6 md:p-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 pb-24">
        <Link
          ...
          className="text-[#d6c0d3] hover:text-[#06B6D4] text-sm tracking-widest uppercase mb-8 inline-block transition-colors"
        >
          ← Back to Marketplace
        </Link>
        ...
        <header className="mb-10 border-b border-white/10 pb-6">
          ...
          <p className="text-[#d6c0d3] text-sm">
            Upload your track and set on-chain licensing terms for instant
            purchases.
          </p>
        </header>
        ...
        >
          ...
          <div className="space-y-6">
            <div className="bg-[#12121A]/80 backdrop-blur-md border border-white/10 rounded-xl p-6 shadow-xl">
              <div className="mb-5">
                <label className="block text-xs font-bold tracking-widest uppercase text-[#d6c0d3] mb-2">
                  Track Title
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-bold tracking-widest uppercase text-[#D946EF] mb-2">
                  License Price (USDC)
                </label>
                <input
                  type="number"
          ...
          <div className="flex flex-col gap-6">
            <div className="flex-1 bg-[#12121A]/80 backdrop-blur-md border border-white/10 rounded-xl p-6 flex flex-col items-center justify-center border-dashed hover:border-[#06B6D4] hover:bg-[#06B6D4]/5 transition-all cursor-pointer group">
              ...
              <h3 className="font-epilogue text-xl font-bold mb-2 text-white">
                Drag & Drop Audio
              </h3>
              <p className="text-sm text-[#d6c0d3] text-center">
                Supports high-quality .WAV or .MP3 up to 50MB
              </p>
              <button
                type="button"
                className="mt-6 px-6 py-2 rounded-full border border-[#06B6D4] text-[#06B6D4] text-sm font-bold tracking-wider uppercase hover:bg-[#06B6D4] hover:text-[#0A0A10] transition-colors"
              >
                Browse Files
              </button>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-4 rounded-xl bg-[#D946EF] text-white font-extrabold tracking-widest uppercase text-lg shadow-[0_0_20px_rgba(217,70,239,0.4)] hover:shadow-[0_0_35px_rgba(217,70,239,0.7)] hover:-translate-y-1 transition-all flex justify-center items-center gap-3"
            >
              <svg
                width="24"
                height="24"
