...
4. **Milestones for the Grant**:
   - **Phase 1 (MVP)**: Code Editor, Cloud Compiler, Testnet Deployment (Currently built!)
   - **Phase 2 (Enhancement)**: Contract Templates, Shareable URLs, Gas Estimators
